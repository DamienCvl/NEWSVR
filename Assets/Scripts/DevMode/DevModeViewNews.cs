...
public class DevModeViewNews : Connection {
    ...
    void Start()
    {
        ...
        MySqlCommand dbcmd = new MySqlCommand("SELECT idNews, title, nbView, nbSad, nbHappy, nbAngry, nbSurprised, nbComment, creationDate FROM NEWS;", con);
